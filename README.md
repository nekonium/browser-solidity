...
Remix is a browser-based compiler and IDE that enables users to build **Nekonium and Ethereum contracts with Solidity language** and to debug transactions.

To try it out, visit [http://nekonium.org/browser-solidity/02/](http://nekonium.org/browser-solidity/02/).
